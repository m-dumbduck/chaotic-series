...
def wishart_clustering(samples: np.array, L: int, r: int, mu: float, return_clusters_indexes: bool=False):
    ...
    if return_clusters_indexes:
        return clst, clst_indexes
    return clst
